 ...
 * 
 */
@WebServiceClient(name = "ConversionImplService", targetNamespace = "http://service.conversion.al23.afcepf.fr/", wsdlLocation = "http://localhost:9090/Serviceweb/ConversionImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/Serviceweb/ConversionImpl?wsdl");
